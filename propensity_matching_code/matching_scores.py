...
if not os.path.exists(f"../results/matching/{subreddit}/scores"):
    os.makedirs(f"../results/matching/{subreddit}/scores")

try:
    results_dict = json.load(open(f'../results/matching/{subreddit}/scores/{propensity_method}.json','r'))
except:
    results_dict = {}
...
try:
    ...
    with open(f'../results/matching/{subreddit}/scores/{propensity_method}.json','w') as fp:
